...
/***************************************************************************
 *  $Log: sidplay2.cpp,v $
 *  Revision 1.2.2.1  2004/07/26 18:11:10  sid
...
const SIDPLAY2_NAMESPACE::SidRegisterFrame& sidplay2::getCurrentRegisterFrame() const
{ 
	return sidplayer.getCurrentRegisterFrame();
}

void sidplay2::setRegisterFrameChangedCallback(void* inInstance, SIDPLAY2_NAMESPACE::SidRegisterFrameChangedCallback inCallback)
{
	sidplayer.setRegisterFrameChangedCallback(inInstance, inCallback);
}
